...
| **T01** | Automated send integration | Wire the existing AI draft tab (already built: draft + mailto/clipboard) to Instantly.ai's actual 3-email automated sequence | T00 | Claude Code (SalesWhiz side) + Drew (Instantly.ai config) |
