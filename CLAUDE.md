...
SynetheixSales (formerly SalesForge, renamed D-32) — a browser-only, screen-reader-first sales dashboard for a non-technical user
...
Instantly.ai email automation (REQ-05/06); see `docs/specs/M7/M7-00-index.md`.
...
**Heading structure:** `<h1>SynetheixSales</h1>` in the app header. Each page section opens with
